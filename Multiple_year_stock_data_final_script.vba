...
Next i
    ...
    If ws.Cells(2, 17).Value = Application.WorksheetFunction.Max(Range("K:K").Value) Then
    ws.Cells(2, 16).Value = ws.Range("I:I").Value
    
    End If
    
    If ws.Cells(3, 17).Value = Application.WorksheetFunction.Min(Range("K:K").Value) Then
    ws.Cells(3, 16).Value = ws.Range("I:I").Value
    
    End If
    
    If ws.Cells(4, 17).Value = Application.WorksheetFunction.Max(Range("L:L").Value) Then
